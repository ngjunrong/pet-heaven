...
const Release = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const release = { name, email, number, petName, petType, reason };

    setIsPending(true);

    fetch("http://localhost:8000/release", {
      method: "POST",
  ...
  return (
    <div style={backgroundStyle}>
      <div className="create">
        ...
        <br /> <br />
        <h2>
          Submit your particulars if you want to find a new home for your pet!
        </h2>
